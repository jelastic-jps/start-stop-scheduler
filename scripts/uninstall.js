...
jelastic.dev.scripting.DeleteScript({${globals.appid}, session: session, name: "uninstall-" + name});

var tasks = jelastic.utils.scheduler.GetTasks({${globals.appid}, session: session}).objects;
var delTasks = [];
