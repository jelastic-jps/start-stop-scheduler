...
jelastic.dev.scripting.DeleteScript({appid: "${globals.appid}", session: session, name: "uninstall-" + name});

var tasks = jelastic.utils.scheduler.GetTasks({appid: "${globals.appid}", session: session}).objects;
var delTasks = [];
